...
(${binFolder}/idam-create-caseworker.sh caseworker,caseworker-divorce,caseworker-divorce-courtadmin,caseworker-divorce-courtadmin_beta kubectl get ingress -n divorcem)
