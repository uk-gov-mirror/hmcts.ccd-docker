...
./ccd-add-role.sh caseworker-autotest1-citizen PRIVATE
...
./idam-create-caseworker.sh caseworker,caseworker-autotest1,caseworker-autotest1-citizen auto.test.cnp+ctzn@gmail.com Pa55word11
./idam-create-caseworker.sh caseworker,caseworker-autotest1,caseworker-autotest1-citizen auto.test.cnp+ctzn1@gmail.com Pa55word11
